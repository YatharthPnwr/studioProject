...
csv_file = os.path.join(eda_dir, "Health_Household_cleaned.csv")
color = "#14b8a6"  # Teal
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_rating_dist.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_price_dist.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_volume_vs_rating.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_correlation_heatmap.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_pivot_heatmap.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_temporal_line.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_Household_completeness.png"), dpi=150, facecolor='#111827')
