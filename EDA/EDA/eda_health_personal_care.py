...
csv_file = os.path.join(eda_dir, "Health_and_Personal_Care_cleaned.csv")
color = "#ec4899"  # Rose
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_rating_dist.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_price_dist.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_volume_vs_rating.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_correlation_heatmap.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_pivot_heatmap.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_temporal_line.png"), dpi=150, facecolor='#111827')
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "Health_and_Personal_Care_completeness.png"), dpi=150, facecolor='#111827')
